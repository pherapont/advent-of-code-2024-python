...
class TestDiskFragmenter(unittest.TestCase):
    ...
    #TODO: найти потерю последнего элемента при дефрагментации и выяснить почему небыло потери в test_defragment_simple_disk()
